...
describe("Login", () => {
    ...
    it("username input takes in value", async () => {
        render(<MockLogin />);
        const userInputElement: HTMLInputElement = screen.getByPlaceholderText("Username");
    ...
    it("forget password underlines on hover", async () => {
        ...
        expect(forgetPwdElement).toHaveClass(
            "text-blue-600 hover:text-blue-700 focus:text-blue-700 active:text-blue-800 duration-200 transition ease-in-out hover:underline"
        );
    });
